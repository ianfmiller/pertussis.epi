...
} else
{
  ...
  if (model=="waning.same.protection.diff.symptoms.diff.transmission.same")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      V_wane_rate = 1/(365*1), 
  ...
  if (model=="waning.diff.protection.same.symptoms.same.transmission.diff")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      Vwp_wane_rate = 1/(365*1), 
  ...
  if (model=="waning.diff.protection.same.symptoms.diff.transmission.same")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      Vwp_wane_rate = 1/(365*1), 
  ...
  if (model=="waning.diff.protection.diff.symptoms.same.transmission.same")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      Vwp_wane_rate = 1/(365*1), 
  ...
  if (model=="waning.same.protection.same.symptoms.same.transmission.diff")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      V_wane_rate = 1/(365*1), 
  ...
  if (model=="waning.same.protection.same.symptoms.diff.transmission.same")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      V_wane_rate = 1/(365*1), 
  ...
  if (model=="waning.same.protection.diff.symptoms.same.transmission.same")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      V_wane_rate = 1/(365*1), 
  ...
  if (model=="waning.diff.protection.same.symptoms.same.transmission.same")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      Vwp_wane_rate = 1/(365*1), 
  ...
  if (model=="waning.same.protection.same.symptoms.same.transmission.same")
  {
    lower.param.bounds<-c(
      Vn_wane_rate = 1/(365*1),
      V_wane_rate = 1/(365*1), 

...
param.names<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_rate","Vwp_fail_rate","Vwp_symptom_rate","Vap_fail_rate","Vap_symptom_rate","naive_symptom_rate","beta0","beta1","beta_mod_An","beta_mod_Av","beta_mod_A","rho","sigmaSE","lag",init.param.names)
...
rproc <- Csnippet("
                  ...
                  // Ewp
                  rate[8] = (1-Vwp_symptom_rate)*latent_trans_rate; // rate of transition from Ewp to Av
                  rate[9] = Vwp_symptom_rate*latent_trans_rate; // rate of transition from Ewp to I
                  rate[10] = death_rate/365.25; // natural mortality
                  
                  // Eap
                  rate[11] = (1-Vap_symptom_rate)*latent_trans_rate; // rate of transition from Eap to Av
                  ...
                  // Vwp
                  rate[25] = Vwp_fail_rate*foi*dw/dt; // rate at which Vwp becomes Ewp
                  rate[26] = V_wane_rate;         // Vwp waning rate
                  rate[27] = death_rate/365.25; // natural mortality
                  
                  // Vap
                  rate[28] = Vap_fail_rate*foi*dw/dt; // rate at which Vap becomes Eap
                  rate[29] = V_wane_rate;         // Vap waning rate
...
partrans=parameter_trans(
  ...
  logit=c("naive_symptom_rate","Vn_fail_rate","Vn_symptom_rate","Vwp_fail_rate","Vwp_symptom_rate","Vap_fail_rate","Vap_symptom_rate","beta_mod_A","beta_mod_An","beta_mod_Av","rho","lag","beta1"),
...
est.pars<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_rate","Vwp_fail_rate","Vwp_symptom_rate","Vap_fail_rate","Vap_symptom_rate","naive_symptom_rate",
            "beta0","beta1","beta_mod_An","beta_mod_Av","beta_mod_A","rho","sigmaSE","lag",
            "S_0","E_0","En_0","Ewp_0","I_0","Vn_0","Vwp_0","A","An_0","Av_0")

rw.sd=rw.sd(Vn_wane_rate=0.01,V_wane_rate=0.01,Vn_fail_rate=0.01,Vn_symptom_rate=0.01,Vwp_fail_rate=0.01,Vwp_symptom_rate=0.01,Vap_fail_rate=ifelse(time >= 9862,0.01,0),Vap_symptom_rate=ifelse(time >= 9862,0.01,0),naive_symptom_rate=0.01,

...
statenames <- c("S","I","Vwp1","Vwp2","Vap","Vn","Awp","Aap","An","W","C")
t0 <- min(dates)

init.names<-c("S_0","I_0","Vwp1_0","Vwp2_0","Vap_0","Vn_0","Awp_0","Aap_0","An_0")
param.names<-c("Vwp1_wane_rate","Vwp2_wane_rate","Vap_wane_rate","Vn_wane_rate","rec_rate","Vwp_fail_rate","Vwp_symptom_rate","Vap_fail_rate","Vap_symptom_rate","Vn_fail_rate","Vn_symptom_rate","beta0","beta1","beta_mod_Awp","beta_mod_Aap","beta_mod_An","rho","sigmaSE","lag","TDaP_waning_boost",init.names)

rproc <- Csnippet("
                  double N, beta, foi, dw, nbirths, Sbirths, Vwp_births1, Vwp_births2, Vap_births, wane_mod_TDaP;
                  double rate[26], trans[26];
                  
                  // pop size
                  N = S+I+Vwp1+Vwp2+Vap+Vn+Awp+Aap+An;
                  ...
                  rate[10] = Vwp2_wane_rate*wane_mod_TDaP;         // Vwp waning rate with aP booster for 4th/5th dose
                  ...
                  rate[14] = Vap_wane_rate*wane_mod_TDaP;         // Vap waning rate
                  rate[15] = death_rate/365.25; // natural mortality
                  
                  //Vn
                  rate[16] = Vn_fail_rate*Vn_symptom_rate*foi*dw/dt; // rate at which Vn becomes I
                  rate[17] = Vn_fail_rate*(1.0-Vn_symptom_rate)*foi*dw/dt; // rate at which Vn becomes An
                  ...
                  rate[25] = death_rate/365.25; // natural mortality
                  ...
                  reulermultinom(2, An, &rate[24], dt, &trans[24]);
                  ...
                  Vn += trans[2] + trans[20] + trans[22] + trans [24] - trans[16] - trans[17] - trans[18] - trans[19];
                  Awp += trans[5] + trans[9] - trans[20] - trans[21];
                  Aap += trans[13] - trans[22] - trans[23];
                  An += trans[17] - trans[24] - trans[25];
...
rinit <- Csnippet("
                  double m = pop/(S_0+I_0+Vwp1_0+Vwp2_0+Vap_0+Vn_0+Awp_0+Aap_0+An_0);
                  S = nearbyint(m*S_0);
                  I = nearbyint(m*I_0);
...
partrans=parameter_trans(
  ...
  barycentric=c("S_0","I_0","Vwp1_0","Vwp2_0","Vap_0","Vn_0","Awp_0","Aap_0","An_0")
)
...
est.pars<-c("TDaP_waning_boost","Vwp1_wane_rate","Vwp2_wane_rate","Vap_wane_rate","Vn_wane_rate","rec_rate","beta0","sigmaSE",
            ...
            "beta_mod_Awp","beta_mod_Aap","beta_mod_An","rho","lag","beta1","S_0","I_0","Vwp1_0","Vwp2_0","Vap_0","Vn_0","Awp_0","Aap_0","An_0")
...
rw.sd=rw.sd(TDaP_waning_boost=0.02,Vwp1_wane_rate=0.02,Vwp2_wane_rate=0.02,Vap_wane_rate=0.02,Vn_wane_rate=0.02,rec_rate=0.02,beta0=0.02,
            ...
            rho=0.02,lag=0.02,beta1=0.02,S_0=0.02,I_0=0.02,Vwp1_0=0.02,Vwp2_0=0.02,Vap_0=0.02,Vn_0=0.02,Awp_0=0.02,Aap_0=0.02,An_0=0.02)

init.values.mat<-data.frame(S_0=LHS[,"S_0"],I_0=LHS[,"I_0"],Vwp1_0=LHS[,"Vwp1_0"],Vwp2_0=LHS[,"Vwp2_0"],Vap_0=LHS[,"Vap_0"],Vn_0=LHS[,"Vn_0"],Awp_0=LHS[,"Awp_0"],Aap_0=LHS[,"Aap_0"],An_0=LHS[,"An_0"])

...
param.names<-c("Vv_wane_rate","Vn_wane_rate","rec_rate","Vv_fail_rate","Vv_symptom_rate","Vn_fail_rate","Vn_symptom_rate","beta0","beta1","beta_mod_Av","beta_mod_An","rho","sigmaSE","lag","TDaP_waning_boost",init.names)
...
rproc <- Csnippet("
                  ...
                  rate[6] = Vv_wane_rate*wane_mod_TDaP;         // Vv waning rate
                  ...
                  rate[10] = Vn_wane_rate*wane_mod_TDaP;         // Vn waning rate
...
rw.sd=rw.sd(TDaP_waning_boost=0.02,Vv_wane_rate=0.02,Vn_wane_rate=0.02,rec_rate=0.02,beta0=0.02,

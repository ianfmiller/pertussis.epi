...
statenames <- c("S","I","Vwp1","Vwp2","Vap","Vn","Anwp","Aap","W","C")
t0 <- min(dates)

init.names<-c("S_0","I_0","Vwp1_0","Vwp2_0","Vap_0","Vn_0","Anwp_0","Aap_0")
param.names<-c("Vwp1_wane_rate","Vwp2_wane_rate","Vap_wane_rate","Vn_wane_rate","rec_rate","Vnwp_fail_rate","Vnwp_symptom_rate","Vap_fail_rate","Vap_symptom_rate","beta0","beta1","beta_mod_Anwp","beta_mod_Aap","rho","sigmaSE","lag","TDaP_waning_boost",init.names)
...
rproc <- Csnippet("
                  ...
                  // pop size
                  N = S+I+Vwp1+Vwp2+Vap+Vn+Anwp+Aap;
                  ...
                  //Vwp1
                  rate[4] = Vnwp_fail_rate*Vnwp_symptom_rate*foi*dw/dt; // rate at which Vwp becomes I
                  rate[5] = Vnwp_fail_rate*(1.0-Vnwp_symptom_rate)*foi*dw/dt; // rate at which Vwp becomes Anwp
                  ...
                  //Vwp2
                  rate[8] = Vnwp_fail_rate*Vnwp_symptom_rate*foi*dw/dt; // rate at which Vwp becomes I
                  rate[9] = Vnwp_fail_rate*(1.0-Vnwp_symptom_rate)*foi*dw/dt; // rate at which Vwp becomes Anwp
                  ...
                  //Vap
                  rate[12] = Vap_fail_rate*Vap_symptom_rate*foi*dw/dt; // rate at which Vap becomes I
                  rate[13] = Vap_fail_rate*(1.0-Vap_symptom_rate)*foi*dw/dt; // rate at which Vap becomes Aap
                  ...
                  //Vn
                  rate[16] = Vnwp_fail_rate*Vnwp_symptom_rate*foi*dw/dt; // rate at which Vn becomes I
                  rate[17] = Vnwp_fail_rate*(1.0-Vnwp_symptom_rate)*foi*dw/dt; // rate at which Vn becomes Anwp
                  rate[18] = Vn_wane_rate*wane_mod_TDaP;         // Vn waning rate
                  rate[19] = death_rate/365.25; // natural mortality
                  
                  //Anwp
                  rate[20] = rec_rate;   // Anwp recovery rate
                  ...
                  reulermultinom(2, Anwp, &rate[20], dt, &trans[20]);
                  ...
                  Anwp += trans[5] + trans[9] + trans[17] - trans[20] - trans[21];
                  Aap += trans[13]  - trans[22] - trans[23];
...
rinit <- Csnippet("
                  double m = pop/(S_0+I_0+Vwp1_0+Vwp2_0+Vap_0+Vn_0+Anwp_0+Aap_0);
                  S = nearbyint(m*S_0);
                  I = nearbyint(m*I_0);
...
partrans=parameter_trans(
  ...
  barycentric=c("S_0","I_0","Vwp1_0","Vwp2_0","Vap_0","Vn_0","Anwp_0","Aap_0")
)
...
est.pars<-c("TDaP_waning_boost","Vwp1_wane_rate","Vwp2_wane_rate","Vap_wane_rate","Vn_wane_rate","rec_rate","beta0","sigmaSE",
            ...
            "beta_mod_Anwp","beta_mod_Aap","rho","lag","beta1","S_0","I_0","Vwp1_0","Vwp2_0","Vap_0","Vn_0","Anwp_0","Aap_0")
...
rw.sd=rw.sd(TDaP_waning_boost=0.02,Vwp1_wane_rate=0.02,Vwp2_wane_rate=0.02,Vap_wane_rate=0.02,Vn_wane_rate=0.02,rec_rate=0.02,beta0=0.02,
            ...
            rho=0.02,lag=0.02,beta1=0.02,S_0=0.02,I_0=0.02,Vwp1_0=0.02,Vwp2_0=0.02,Vap_0=0.02,Vn_0=0.02,Anwp_0=0.02,Aap_0=0.02)

init.values.mat<-data.frame(S_0=LHS[,"S_0"],I_0=LHS[,"I_0"],Vwp1_0=LHS[,"Vwp1_0"],Vwp2_0=LHS[,"Vwp2_0"],Vap_0=LHS[,"Vap_0"],Vn_0=LHS[,"Vn_0"],Anwp_0=LHS[,"Anwp_0"],Aap_0=LHS[,"Aap_0"])

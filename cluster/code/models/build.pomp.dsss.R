...
param.names<-c("Vn_wane_rate","Vwp_wane_rate","Vap_wane_rate","Vn_fail_rate","Vn_symptom_rate","V_fail_rate","V_symptom_rate","naive_symptom_rate","beta0","beta1","beta_mod_An","beta_mod_Av","beta_mod_A","rho","sigmaSE","lag",init.param.names)
...
rproc <- Csnippet("
                  ...
                  // Vwp
                  rate[22] = V_fail_rate*foi*dw/dt; // rate at which Vwp becomes Ev
                  rate[23] = Vwp_wane_rate;         // Vwp waning rate
                  rate[24] = death_rate/365.25; // natural mortality
                  
                  // Vap
                  rate[25] = V_fail_rate*foi*dw/dt; // rate at which Vap becomes Ev

...
param.names<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_mod","V_fail_rate","V_symptom_mod","naive_symptom_rate","beta0","beta1","beta_mod_An","beta_mod_Awp","beta_mod_Aap","beta_mod_A","rho","sigmaSE","lag",init.param.names)
...
rproc <- Csnippet("
                  ...
                  // Ewp
                  rate[8] = (1-pow(naive_symptom_rate,1+V_symptom_mod))*latent_trans_rate; // rate of transition from Ewp to Awp
                  rate[9] = pow(naive_symptom_rate,1+V_symptom_mod)*latent_trans_rate; // rate of transition from Ewp to I
                  rate[10] = death_rate/365.25; // natural mortality
                  
                  // Eap
                  rate[11] = (1-pow(naive_symptom_rate,1+V_symptom_mod))*latent_trans_rate; // rate of transition from Ewp to Aap
                  rate[12] = pow(naive_symptom_rate,1+V_symptom_mod)*latent_trans_rate; // rate of transition from Ewp to I
                  ...
                  // Vwp
                  rate[27] = V_fail_rate*foi*dw/dt; // rate at which Vwp becomes Ewp
                  rate[28] = V_wane_rate;         // Vwp waning rate
                  rate[29] = death_rate/365.25; // natural mortality
                  
                  // Vap
                  rate[30] = V_fail_rate*foi*dw/dt; // rate at which Vap becomes Eap
                  rate[31] = V_wane_rate;         // Vap waning rate
...
partrans=parameter_trans(
  ...
  logit=c("naive_symptom_rate","Vn_fail_rate","V_fail_rate","beta_mod_A","beta_mod_An","beta_mod_Awp","beta_mod_Aap","rho","lag","beta1"),

...
param.names<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_rate","V_fail_rate","V_symptom_rate","naive_symptom_rate","beta0","beta1","beta_mod_An","beta_mod_Awp","beta_mod_Aap","beta_mod_A","rho","sigmaSE","lag",init.param.names)
...
partrans=parameter_trans(
  ...
  logit=c("naive_symptom_rate","Vn_fail_rate","Vn_symptom_rate","V_fail_rate","V_symptom_rate","beta_mod_A","beta_mod_An","beta_mod_Awp","beta_mod_Aap","rho","lag","beta1"),

...
param.names<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_mod","Vwp_fail_rate","V_symptom_mod","Vap_fail_rate",
...
partrans=parameter_trans(
  ...
  logit=c("naive_symptom_rate","Vn_fail_rate","Vwp_fail_rate","Vap_fail_rate","beta_mod_A","beta_mod_An","beta_mod_Awp","beta_mod_Aap","rho","lag","beta1"),
...
est.pars<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_mod","Vwp_fail_rate","V_symptom_mod","Vap_fail_rate","naive_symptom_rate",
...
rw.sd=rw.sd(Vn_wane_rate=0.01,V_wane_rate=0.01,Vn_fail_rate=0.01,Vn_symptom_mod=0.01,Vwp_fail_rate=0.01,V_symptom_mod=0.01,Vap_fail_rate=ifelse(time >= 9862,0.01,0),naive_symptom_rate=0.01,

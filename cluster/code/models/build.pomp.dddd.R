...
param.names<-c("Vn_wane_rate","Vwp_wane_rate","Vap_wane_rate","Vn_fail_rate","Vn_symptom_mod","Vwp_fail_rate","Vwp_symptom_mod","Vap_fail_rate","Vap_symptom_mod","naive_symptom_rate","beta0","beta1","beta_mod_An","beta_mod_Awp","beta_mod_Aap","beta_mod_A","rho","sigmaSE","lag",init.param.names)
...
rproc <- Csnippet("
                  ...
                  // Ewp
                  rate[8] = (1-pow(naive_symptom_rate,1+Vwp_symptom_mod))*latent_trans_rate; // rate of transition from Ewp to Awp
                  ...
                  // Eap
                  rate[11] = (1-pow(naive_symptom_rate,1+Vap_symptom_mod))*latent_trans_rate; // rate of transition from Ewp to Aap
...
est.pars<-c("Vn_wane_rate","Vwp_wane_rate","Vap_wane_rate","Vn_fail_rate","Vn_symptom_mod","Vwp_fail_rate","Vwp_symptom_mod","Vap_fail_rate","Vap_symptom_mod","naive_symptom_rate",
...
rw.sd=rw.sd(Vn_wane_rate=0.01,Vwp_wane_rate=0.01,Vap_wane_rate=ifelse(time >= 9862,0.01,0),Vn_fail_rate=0.01,Vn_symptom_mod=0.01,Vwp_fail_rate=0.01,Vwp_symptom_mod=0.01,Vap_fail_rate=ifelse(time >= 9862,0.01,0),Vap_symptom_mod=ifelse(time >= 9862,0.01,0),naive_symptom_rate=0.01,
...
params.mat<-cbind(
  data.frame(
    ...
    Vwp_fail_rate=LHS[,"Vwp_fail_rate"],Vwp_symptom_mod=LHS[,"Vwp_symptom_mod"],Vap_fail_rate=LHS[,"Vap_fail_rate"], Vap_symptom_mod=LHS[,"Vap_symptom_mod"],naive_symptom_rate=LHS[,"naive_symptom_rate"],

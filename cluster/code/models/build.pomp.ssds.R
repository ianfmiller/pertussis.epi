...
param.names<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_rate","V_fail_rate","Vwp_symptom_rate","Vap_symptom_rate","naive_symptom_rate","beta0","beta1","beta_mod_An","beta_mod_Av","beta_mod_A","rho","sigmaSE","lag",init.param.names)
...
partrans=parameter_trans(
  ...
  logit=c("naive_symptom_rate","Vn_fail_rate","Vn_symptom_rate","V_fail_rate","Vwp_symptom_rate","Vap_symptom_rate","beta_mod_A","beta_mod_An","beta_mod_Av","rho","lag","beta1"),
...
est.pars<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_rate","V_fail_rate","Vwp_symptom_rate","Vap_symptom_rate","naive_symptom_rate",
            "beta0","beta1","beta_mod_An","beta_mod_Av","beta_mod_A","rho","sigmaSE","lag",
            "S_0","E_0","En_0","Ewp_0","I_0","Vn_0","Vwp_0","A","An_0","Av_0")

rw.sd=rw.sd(Vn_wane_rate=0.01,V_wane_rate=0.01,Vn_fail_rate=0.01,Vn_symptom_rate=0.01,V_fail_rate=0.01,Vwp_symptom_rate=0.01,Vap_symptom_rate=ifelse(time >= 9862,0.01,0),naive_symptom_rate=0.01,
...
params.mat<-cbind(
  data.frame(
    ...
    V_fail_rate=LHS[,"V_fail_rate"],Vwp_symptom_rate=LHS[,"Vwp_symptom_rate"], Vap_symptom_rate=LHS[,"Vap_symptom_rate"],naive_symptom_rate=LHS[,"naive_symptom_rate"],

...
param.names<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_mod","V_fail_rate","V_symptom_mod","naive_symptom_rate","beta0","beta1","beta_mod_An","beta_mod_Av","beta_mod_A","rho","sigmaSE","lag",init.param.names)
...
partrans=parameter_trans(
  log=c("Vn_wane_rate","V_wane_rate","beta0","sigmaSE","Vn_symptom_mod","V_symptom_mod"),
...
est.pars<-c("Vn_wane_rate","V_wane_rate","Vn_fail_rate","Vn_symptom_mod","V_fail_rate","V_symptom_mod","naive_symptom_rate",
            "beta0","beta1","beta_mod_An","beta_mod_Av","beta_mod_A","rho","sigmaSE","lag",
            "S_0","E_0","En_0","Ev_0","I_0","Vn_0","V_0","A","An_0","Av_0")

rw.sd=rw.sd(Vn_wane_rate=0.01,V_wane_rate=0.01,Vn_fail_rate=0.01,Vn_symptom_mod=0.01,V_fail_rate=0.01,V_symptom_mod=0.01,naive_symptom_rate=0.01,
...
params.mat<-cbind(
  data.frame(
    Vn_wane_rate=LHS[,"Vn_wane_rate"],V_wane_rate = LHS[,"V_wane_rate"], Vn_fail_rate=LHS[,"Vn_fail_rate"],Vn_symptom_mod=LHS[,"Vn_symptom_mod"],
    V_fail_rate=LHS[,"V_fail_rate"],V_symptom_mod=LHS[,"V_symptom_mod"],naive_symptom_rate=LHS[,"naive_symptom_rate"],
